...
void cMenu::DrawMenu()
{
	...
	if (ImGui::Begin("discord.gg/hN7RTHGh8u - ScreenGC", &g_vars->msettings.b_menuEnable, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize |
		ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse))
	{
		...
		if (ImGui::BeginChild("Line", ImVec2(-1, 25), false, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize |
			...
			ImGui::SetCursorPosX((ImGui::GetWindowWidth() - ImGui::CalcTextSize("ScreenCG#2273").x) / 2);
			ImGui::TextColored(ImVec4(color_menu[0], color_menu[1], color_menu[2], 1.0f), "");
		}
		ImGui::EndChild();
		ImGui::PopFont();
